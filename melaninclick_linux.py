...
class InstallPage(tk.Frame):
    ...
    def check_storage_and_install_bitcoin(self):
        ...
        if free_space > 600:
            ...
            self.install('bitcoin-regtest', "https://bitcoincore.org/bin/bitcoin-core-22.0/bitcoin-22.0-x86_64-linux-gnu.tar.gz")
        else:
            self.update_output("Insufficient storage space for Bitcoin. Please free up some space and try again.")

    def install_lnd(self):
        self.install('lnd', "https://github.com/lightningnetwork/lnd/releases/download/v0.17.0-beta.rc2/lnd-linux-amd64-v0.17.0-beta.rc2.tar.gz")

    def install_whive(self):
        self.install('whive', "https://github.com/whiveio/whive/releases/download/v2.22.1/whive-2.22.1-x86_64-linux-gnu.tar.gz")
